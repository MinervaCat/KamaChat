...
type PushClient interface {
	Push(ctx context.Context, in *PushRequest, opts ...grpc.CallOption) (*ResponseForPush, error)
}
...
func (c *pushClient) Push(ctx context.Context, in *PushRequest, opts ...grpc.CallOption) (*ResponseForPush, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ResponseForPush)
...
type PushServer interface {
	Push(context.Context, *PushRequest) (*ResponseForPush, error)
...
func (UnimplementedPushServer) Push(context.Context, *PushRequest) (*ResponseForPush, error) {
