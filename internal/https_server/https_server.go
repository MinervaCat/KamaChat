...
func init() {
	...
	GE.POST("/session/getSessionList", v1.GetConversationList)
	GE.POST("/conversation/getConversationList", v1.GetConversationList)
	GE.POST("/session/deleteSession", v1.DeleteConversation)
	GE.POST("/session/checkOpenSessionAllowed", v1.CheckOpenConversationAllowed)
	GE.POST("/contact/getUserList", v1.GetFriendList)
	//GE.POST("/contact/loadMyJoinedGroup", v1.LoadMyJoinedGroup)
	//GE.POST("/contact/getContactInfo", v1.GetRInfo)
	//GE.POST("/contact/deleteContact", v1.DeleteContact)
	GE.POST("/contact/applyContact", v1.ApplyFriend)
	GE.POST("/contact/getNewContactList", v1.GetNewApplyList)
	GE.POST("/contact/passContactApply", v1.PassRelationApply)
	...
	GE.POST("/contact/refuseContactApply", v1.RefuseRelationApply)
	GE.POST("/contact/blackApply", v1.BlackApply)
	//GE.POST("/message/getMessageList", v1.GetMessageList)
	GE.POST("/message/getMessageAfterSeq", v1.GetMessageAfterSeq)
